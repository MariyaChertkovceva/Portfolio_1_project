Для тестирования функционального объекта `Товары на сайте` , была использована техника состояний и переходов, что позволило исследовать компонент и собрать всю необходимую информацию. 
